...
## Software requirement verification documents
...
1. Select the SWR or SWRVS artifact type.
2. Read its authoritative rule.
3. Copy its skeleton for each authored artifact.
4. Use its example only as a formatting reference.
