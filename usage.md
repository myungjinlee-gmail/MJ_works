...
This guide contains setup, build, configuration, testing, quality-check, and
repository-layout information for MJ_works. For the project goal, scope, and
current maturity, see the [project overview](README.md).
